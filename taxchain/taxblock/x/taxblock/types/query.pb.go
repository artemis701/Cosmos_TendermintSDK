...
// source: taxblock/taxblock/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_d41af0e742a92e8d, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_d41af0e742a92e8d, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "taxblock.taxblock.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "taxblock.taxblock.QueryParamsResponse")
}

func init() { proto.RegisterFile("taxblock/taxblock/query.proto", fileDescriptor_d41af0e742a92e8d) }

var fileDescriptor_d41af0e742a92e8d = []byte{
	// 278 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2d, 0x49, 0xac, 0x48,
	...
	0xc2, 0x63, 0x39, 0x86, 0x1b, 0x8f, 0xe5, 0x18, 0xa2, 0x24, 0xe1, 0x4a, 0x2b, 0x90, 0xb4, 0x57,
	0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0xc3, 0xc9, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x80, 0xc4,
	0x0a, 0x4a, 0xdb, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/taxblock.taxblock.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/taxblock.taxblock.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "taxblock.taxblock.Query",
	...
	Metadata: "taxblock/taxblock/query.proto",
}
